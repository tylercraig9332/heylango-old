...
export default function Badge(props : {type: string, custom?: string}) {
    ...
    switch (props.type) {
        ...
        case 'supporterGold':
            return <Tag color="gold"><Icon type="star" theme="filled"/> {props.custom} <Icon type="star" theme="filled"/></Tag>
        case 'supporterDiamond':
            return <Tag color="#B9F2FF" style={{border: '1px solid #1890ff'}}><span style={{color: '#1890ff'}} ><Icon type="rocket" theme="twoTone" /> {props.custom} <Icon type="rocket" theme="twoTone" /></span></Tag>
        case 'custom':
